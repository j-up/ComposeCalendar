...
val lightCalendarColors: CalendarColors = CalendarColors(
    ...
    selectedDay = Color(parseColor("#fd7d31")),
    unselectedDay = Color(parseColor("#cbcdd4")),
)

val darkCalendarColors: CalendarColors = CalendarColors(
    ...
    selectedDay = Color(0xfffd7d31),
    unselectedDay = Color(0xffcbcdd4)
)
